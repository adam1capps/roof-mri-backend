...
Click **Manual Deploy** > **Deploy latest commit**. Render will install everything and start your server.

You'll get a URL like `https://roof-mri-backend.onrender.com`.
